...
import { Users, UserPlus, Search, Mail, Shield, ShieldCheck, X } from 'lucide-react';
          ...
          {filteredTeam.map((member, i) => (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-center justify-center text-sm text-gray-500 hover:text-gray-300 transition-colors cursor-pointer mb-2">
